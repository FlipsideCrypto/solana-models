...
select 'deposit' as action, *
from deposit_events 
union 
select 'deposit_dao' as action, *
from deposit_dao_events 
union 
select 'deposit_dao_with_referrer' as action, *
from deposit_dao_with_referrer_events 
union 
select 'deposit_stake' as action, *
from deposit_stake_events 
union 
select 'deposit_dao_stake' as action, *
from deposit_dao_stake_events 
union 
select 'withdraw' as action, *
from withdraw_events
union 
select 'withdraw_stake' as action, *
from withdraw_stake_events
