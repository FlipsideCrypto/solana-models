...
prev_null_block_timestamp_txs AS (
    SELECT
        ...
        null as compute_units_consumed_test,
        null as compute_units_total_test,
        t.version,
        t._partition_id,
        GREATEST(
            t._inserted_timestamp,
...
SELECT
    ...
    silver.udf_get_compute_units_consumed(log_messages) as compute_units_consumed_test,
    silver.udf_get_compute_units_total(log_messages) as compute_units_total_test,
    version,
    _partition_id,
    _inserted_timestamp
FROM
