...
$$
    ...
    try {
        ...
        snowflake.execute({sqlText: `ALTER TABLE ${DESTINATION_DB_NAME}.SILVER.TRANSFERS DROP SEARCH OPTIMIZATION;`});
        snowflake.execute({sqlText: `ALTER TABLE ${DESTINATION_DB_NAME}.SILVER.SWAPS_INTERMEDIATE_JUPITERV4 DROP SEARCH OPTIMIZATION;`});
